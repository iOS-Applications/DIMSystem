...
@implementation WDDocumentCellTableViewCell
...
- (void)bindModel:(WDDocument *)WDDocument
{
    ...
    UIImage *img = nil;
    switch (WDDocument.documentType) {
    ...
    NSAttributedString *attrStr = [[NSAttributedString alloc] initWithString:WDDocument.name attributes:attr];
    self.fileNameLabel.attributedText = attrStr;
    self.fileSizeLabel.text = [self stringFromFileSize:WDDocument.fileSize];
