...
- (void)layoutSubviews
{
    ...
    for (int i = 0; i < self.imageArrays.count; i ++ ) {
        ...
        CGFloat imageY = 0.f;
        _imageView.frame = CGRectMake(imageX, imageY, width, height);
        [_imageView setBackgroundImage:[UIImage imageNamed:self.imageArrays[i]] forState:UIControlStateNormal];
